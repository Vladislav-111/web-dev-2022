...
def parse_cdp_neighbors(command_output):
    ...
    for line in command_output.split('\n'):
        ...
        elif len(colum) >= 1 and colum[3].isdigit():
            device, inteface, interface_num, *other, port, port_num = colum
            result[(hostname, inteface + interface_num)] = (device, port + port_num)
    return result


if __name__ == "__main__":
    with open('web-dev-python/task_11/sh_cdp_n_sw1.txt') as f:
