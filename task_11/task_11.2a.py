...
"""
infiles = [
    "web-dev-python/task_11/sh_cdp_n_sw1.txt",
    "web-dev-python/task_11/sh_cdp_n_r1.txt",
    "web-dev-python/task_11/sh_cdp_n_r2.txt",
    "web-dev-python/task_11/sh_cdp_n_r3.txt",
]
...
if __name__ == "__main__":
    ...
    print(unique_network_map(network))